...
const navLinks = [
  ...
  { label: "About", href: "/about" },
  {
    ...
    href: "/courses",
    dropdown: [
      { label: "Java Full Stack +AI",     href: "/courses/java",           logo: "/course-logos/java.svg",        color: "#F89820" },
      { label: "Python Full Stack +AI",  href: "/courses/python",         logo: "/course-logos/python.svg",      color: "#3776AB" },
      ...
      { label: "Data Science+AI",        href: "/courses/data-science",   logo: "/course-logos/datascience.svg", color: "#8B5CF6" },
